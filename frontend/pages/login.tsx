...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <Head>
        <title>Login - InvoSmart AI</title>
      </Head>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        >
          <Link href="/" className="flex items-center justify-center">
            <span className="text-3xl font-bold text-blue-500">InvoSmart</span>
            <span className="ml-2 text-2xl font-semibold text-white">AI</span>
          </Link>
